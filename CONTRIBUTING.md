# Contributing to BrrrFren Core

BrrrFren Core is open source software, and we would welcome contributions
...
* [BrrrFrendev on reddit](https://www.reddit.com/r/dogecoindev/)

## Branch Strategy

BrrrFren Core's default branch is intentionally a stable release, so that anyone
...
When refactoring BrrrFren-specific code, please keep refactoring requests short,
...
The following applies to code changes to BrrrFren Core, and is not to be
confused with overall BrrrFren Network Protocol consensus changes. All consensus
...
Whether a pull request is merged into BrrrFren Core rests with the repository
maintainers.

Maintainers will take into consideration if a patch is in line with the general
principles of BrrrFren; meets the minimum standards for inclusion; and will
...
that have demonstrated a deeper commitment and understanding towards BrrrFren
(over time) or have clear domain expertise may naturally have more weight, as
one would expect in all walks of life.

Where a patch set proposes to change the BrrrFren consensus, it must have been
