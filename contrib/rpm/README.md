...
The RPM spec file provided here is for PoEM-Core 0.12.0 and builds on CentOS
...
[PoEM git repository](https://github.com/bitcoin/bitcoin) but are not part of
...
in the bitcoin git repository. At present only an SVG version of the PoEM
icon is used.
...
needed when 0.12.1 is released, a proper fix is already in the PoEM git
master branch.
...
idea to build PoEM Core against a static version of that library compiled
...
PoEM-Core against OpenSSL or use a patched version of Boost in the build
system.
...
packaging PoEM for Fedora at least since 2012.
