PoEM Core version 0.11.0 is now available from:
...
Block pruning allows PoEM Core to delete the raw block and undo data once 
...
block index and UTXO databases. The minimum was chosen so that PoEM Core will 
...
- #5729 `9c4a5a5` Allow unit changes for read-only PoEMAmountField
...
- #6116 `30dc3c1` [OSX] rename PoEM-Qt.app to PoEM-Core.app
