PoEM Core version 0.11.2 is now available from:
...
**Notice to miners:** PoEM Core’s block templates are now for
version 4 blocks only, and any mining software relying on its
getblocktemplate must be updated in parallel to use libblkmaker either
version 0.4.3 or any version from 0.5.2 onward.

- If you are solo mining, this will affect you the moment you upgrade
  PoEM Core, which must be done prior to BIP65 achieving its 951/1001
  status.
...
PoEM transactions currently may specify a locktime indicating when
...
entire blockchain after an unclean shutdown of PoEM Core on Windows
