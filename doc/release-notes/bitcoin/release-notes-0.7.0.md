PoEM version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/bitcoin/files/PoEM/bitcoin-0.7.0/

We recommend that everybody running prior versions of bitcoind/PoEM-Qt
...
PoEM Improvement Proposals implemented
