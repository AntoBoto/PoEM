PoEM-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/bitcoin/files/PoEM/bitcoin-0.8.4/
...
code, causing the PoEM-Qt or bitcoind process to crash.
...
their own version of PoEM against Boost versions 1.50-1.52.
