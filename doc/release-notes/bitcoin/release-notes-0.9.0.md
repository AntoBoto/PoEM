PoEM Core version 0.9.0 is now available from:
...
earlier versions of PoEM, then run the installer (on Windows) or just copy
over /Applications/PoEM-Qt (on Mac) or bitcoind/bitcoin-qt (on Linux).

If you are upgrading from version 0.7.2 or earlier, the first time you run
0.9.0 your blockchain files will be re-indexed, which will take anywhere from 
30 minutes to several hours, depending on the speed of your machine.

On Windows, do not forget to uninstall all earlier versions of the PoEM
...
Rebranding to PoEM Core
---------------------------

To reduce confusion between PoEM-the-network and PoEM-the-software we
have renamed the reference client to PoEM Core.
...
Using the standard "./autogen.sh; ./configure; make" to build PoEM-Qt and
