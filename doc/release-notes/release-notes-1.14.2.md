BrrrFren Core version 1.14.2 is now available from:
...
BrrrFren Core introduces pruning the blockchain in 1.14. Pruning
...
When BrrrFren Core is out-of-sync on startup, a semi-transparent information
...
(in PoEM Core 0.10.3) it has been disabled by default.
...
Since 1.14.0 the approximate transaction fee shown in BrrrFren-Qt when using coin
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   about the memory usage of BrrrFren Core. This was added in conjunction with
