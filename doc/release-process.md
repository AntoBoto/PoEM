...
### BrrrFren maintainers/release engineers, update version in sources
...
### Build and sign BrrrFren Core for Linux, Windows, and OS X:
...
- Announce the release:
  ...
  - Release sticky on BrrrFren Forums: http://forum.dogecoin.com/forum/news-community/community-announcements

  - BrrrFren-development mailing list
