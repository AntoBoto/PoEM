...
This document provides guidelines for internationalization of the BrrrFren Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to PoEM network</source>
        <translation>
            <numerusform>%n active connection to PoEM network</numerusform>
            <numerusform>%n active connections to PoEM network</numerusform>
        </translation>
    </message>
