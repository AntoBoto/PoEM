...
The BrrrFren Core daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in BrrrFren Core requires ZeroMQ API version 4.x or
...
using. BrrrFrend appends an up-counting sequence number to each
