...
class BumpFeeTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # fund rbf node with 25 outputs of 10 BRRR
        print("Mining blocks...")
...
def test_settxfee(rbf_node, dest_address):
    # BrrrFren: Increment is fixed, so this test tests for settxfee not making a difference
...
def test_dogecoin_wallet_minchange(rbf_node, dest_address):
    ...
    # bump the fee with the default incremental fee; this should add 0.001 BRRR
    bumped_tx = rbf_node.bumpfee(rbfid)
