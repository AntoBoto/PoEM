...
class P2PPolicyTests(BitcoinTestFramework):
    ...
    def setup_network(self):
        ...
        # a BrrrFren Core node that behaves similar to mainnet policies
    ...
    def run_test(self):
        ...
        ### test constants ###
        koinu = Decimal("0.00000001")          # 1 Koinu expressed in BRRR
        ten = Decimal("10.0")                  # uniform 10 BRRR seed moneys
        ...
        # create a bunch of UTXO with seed money from the BrrrFren Core wallet
        for i in range(20):
        ...
        # test legacy output of 1 BRRR output and 1 BRRR fee
    ...
    # spend seed money with a key not in the BrrrFren Core wallet.
    def spend_utxo(self, output, expected_size, retries=0):
        # construct the transaction using BrrrFren Core raw tx APIs
        ...
        # and send the tx from there rather than from BrrrFren Core, to test
