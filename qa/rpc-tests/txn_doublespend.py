...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 7,500,000 BRRR:
        ...
        # First: use raw transaction API to send 7440000 BRRR to node1_address,
        # but don't broadcast:
        ...
        # Node0's balance should be starting balance, plus 500,000 BRRR for another
        ...
        # Node0's total balance should be starting balance, plus 1000000 BRRR for 
