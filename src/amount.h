 ...
 *
 * Note that this constant is *not* the total money supply, which in PoEM
 ...
 * */
static const CAmount MAX_MONEY = 10000000000 * COIN; // BrrrFren: maximum of 100B coins (given some randomness), max transaction 10,000,000,000
