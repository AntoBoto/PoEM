/* src/config/poem-config.h.  Generated from poem-config.h.in by configure.  */
/* src/config/poem-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* #undef ALLOW_BRRRCOIN_EXPERIMENTAL */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The PoEM Core Developers developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "PoEM Core Developers"

/* Copyright year */
#define COPYRIGHT_YEAR 2025

/* Date of the current release */
#define CURRENT_RELEASE_DATE "2025-05-29"
...
#define EXPECTED_DAYS_TO_NEXT_RELEASE 90
...
#define PACKAGE_BUGREPORT "info@poem.technology"

/* Define to the full name of this package. */
#define PACKAGE_NAME "PoEM Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "PoEM Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "poem"
