...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s poem-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
              "Usage:  poem-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded PoEM transaction") + "\n" +
              "  or:     poem-tx [options] -create [commands]   " + _("Create hex-encoded PoEM transaction") + "\n" +
              "\n";
...
static void MutateTxAddOutPubKey(CMutableTransaction& tx, const std::string& strInput)
{
    ...
    CPoEMAddress addr(scriptPubKey);
    ...
    if (bScriptHash) {
        ...
        CPoEMAddress redeemScriptAddr(scriptPubKey);
