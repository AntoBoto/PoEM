...
/** Recommended transaction fee by BrrrFren Core developers
  *
 ...
 *
 *  BrrrFren:    Increment mempool limits and accept RBF in steps of 0.0001 BRRR
...
/**
 * BrrrFren: Default dust limit that is evaluated when considering whether a
...
/**
 * BrrrFren: Default hard dust limit that is evaluated when considering whether
