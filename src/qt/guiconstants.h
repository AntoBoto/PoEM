...
/* PoEMGUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "BrrrFren"
#define QAPP_ORG_DOMAIN "brrrfren.com"
#define QAPP_APP_NAME_DEFAULT "BrrrFren-Qt"
#define QAPP_APP_NAME_TESTNET "BrrrFren-Qt-testnet"
