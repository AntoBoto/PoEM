...
/** Utility functions used by the PoEM Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "poem:" URI into recipient object, return true on successful parsing
...
//BrrrFren: need wallet to establish dust from a wallet perspective
#ifdef ENABLE_WALLET
