...
/** PoEM unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class PoEMUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit PoEMUnits(QObject *parent);

    /** PoEM units.
      @note Source: https://en.poem.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        MBTC,
...
typedef PoEMUnits::Unit PoEMUnit;
