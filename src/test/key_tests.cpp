// Copyright (c) 2012-2015 The PoEM Core developers
...
static const CPoEMAddress addr1 ("DSpgzjPyfQB6ZzeSbMWpaZiTTxGf2oBCs4");
static const CPoEMAddress addr2 ("DR9VqfbWgEHZhNst34KQnABQXpPWXeLAJD");
static const CPoEMAddress addr1C("D8jZ6R8uuyQwiybupiVs3eDCedKdZ5bYV3");
static const CPoEMAddress addr2C("DP7rGcDbpAvMb1dKup981zNt1heWUuVLP7");
...
void dumpKeyInfo(uint256 privkey)
{
    ...
    for (int nCompressed=0; nCompressed<2; nCompressed++)
    {
        ...
        printf("    * address (base58): %s\n", CPoEMAddress(vchPubKey).ToString().c_str());
    }
}
#endif
...
{
    CPoEMSecret bsecret1, bsecret2, bsecret1C, bsecret2C, baddress1;
